...
## Algorithm
1. Import necessary libraries such as pandas, numpy, matplotlib, and sklearn.
2. Load the dataset and convert the time column into datetime format.
3. Sort the data and handle missing values using interpolation
4. Perform feature engineering by extracting time-based features and creating lag variables.
5. Split the dataset into training and testing sets.
6. Train the Random Forest Regressor model for each target variable.
7. Evaluate the model using R² score and Mean Absolute Error (MAE).
8. Visualize predictions and feature importance using plots.
9. Use the trained model to predict future values based on latest data. 
...
```
## Output:
<img width="1241" height="135" alt="image" src="https://github.com/user-attachments/assets/b36b9855-46c9-4f44-8486-086c4e022dce" />

<img width="1589" height="1789" alt="image" src="https://github.com/user-attachments/assets/c3bac339-182a-4daa-9afb-193143f5400e" />

<img width="1248" height="106" alt="image" src="https://github.com/user-attachments/assets/17a7f361-8d1d-49f6-8937-02da97cfe463" />

## Result:
Thus, the Random Forest model was successfully implemented to predict temperature, PM2.5 levels, and solar energy, achieving good accuracy with low error values.
